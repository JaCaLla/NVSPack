...
class AssetUtilizationViewContent: DemoBaseViewController {
    ...
    func setupViewContent() {
        ...
        lblTitle.text = R.string.localized.assetutilization_title()
        lblTitle.numberOfLines = 1
        lblTitle.font = FontsNVSPack.AssetUtilization.titleFont
        lblTitle.textColor = ColorsNVSPack.AssetUtilization.titleFontColor
    ...
    func setDataCount( dataset:Dataset) {
        ...
        if let serie = dataset.series.first( where : { $0.label == "GOOD" }) {
            ...
            let myAttribute = [ NSAttributedStringKey.font: FontsNVSPack.AssetUtilization.holeFont,
                                NSAttributedStringKey.foregroundColor: ColorsNVSPack.AssetUtilization.holeFontColor,
